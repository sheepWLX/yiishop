		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->img[0]->path."?imageView2/2/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->img[0]->path."?imageView2/2/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($good->img as $key=>$img){?>
								<li class="<?=$key>0?"":"cur"?>">
									<a class="<?=$key>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1',
									smallimage: '<?=$img->path."?imageView2/2/w/350/h/350"?>',
									largeimage: '<?=$img->path."?imageView2/2/w/800/h/800"?>'}"><img src="<?=$img->path."?imageView2/2/w/50/h/50"?>"></a>
								</li>
                                <?php } ?>
                            </ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=date('Ymd H:i',$good->create_time)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="/">(已有<?=rand(0,999)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
