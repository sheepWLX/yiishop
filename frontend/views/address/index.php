    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                ...
                <dd>
                    <a href="/">修改</a>
                    <a href="<?=\yii\helpers\Url::to(['address/del','id'=>$address->id])?>" id="del">删除</a>
                    <a href="<?=\yii\helpers\Url::to(['address/default','id'=>$address->id])?>">设为默认地址</a>
                </dd>
            </dl>
            <?php } ?>
        </div>
        ...
        <div class="address_bd mt10">
            ...
            <form action="" name="address_form" id="address_form">
                ...
                <ul>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="button" name="" class="btn" value="保存" id="address_btn" />
                    </li>
                </ul>
            </form>
        </div>
